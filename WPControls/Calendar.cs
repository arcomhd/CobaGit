...
namespace WPControls
{
    ...
    public class Calendar : Control
    {
        ...
        protected void OnMonthChanged(int year, int month)
        {
            if (MonthChanged != null)
            {
                ...
                if (this._itemsGrid != null)
                {
                    ...
                    {
                        var query2 = from oneChild in this._itemsGrid.Children
                                     where
        ...
        {
            get { return (DateTime[])GetValue(SelectedDatesProperty); }
        ...
        public static readonly DependencyProperty SelectedDatesProperty =
           DependencyProperty.Register("SelectedDates", typeof(DateTime[]), typeof(Calendar), new PropertyMetadata(null));
        ...
        {
            if (_dateTimeFormatInfo.AbbreviatedDayNames[0].ToUpper() == "MGG")
            {
                Sunday = "MIN";
            }
            else
